// global
import {
  Actor, DatabaseTransactionHandler,
  ItemMembershipService,
  ItemService, Member, MemberService
} from 'graasp';
// local
...
export class ItemLoginWithUsernameTask extends ItemLoginWithTask {
  get name(): string { return ItemLoginWithUsernameTask.name; }
  private credentials: { username: string; password?: string };

  constructor(actor: Actor, itemId: string, credentials: { username: string, password?: string },
